...
test('clicking buttonn increments counter display', () => {
  const counter = 7;
...
test('clicking button decrement when counter equal 0', () => {
  const counter = 0;
  const wrapper = setup(null, { counter });
...
test('clicking button increment when counter equal 0', () => {
  const counter = 0;
  const isError = true;
